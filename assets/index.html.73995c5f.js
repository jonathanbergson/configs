import{r as l,o as p,c as r,b as s,a as c,F as t,d as n,e as a}from"./app.3b2bb485.js";import{_ as i}from"./plugin-vue_export-helper.21dcd24c.js";var o="/assets/macos-dashboard-minimal.13d199f1.png",b="/assets/macos-settings-hot-corners.ccd8031f.png",m="/assets/macos-settings-keyboard-input-sources.e1c3e9be.png",u="/assets/macos-settings-accessibility.c13c578c.png",d="/assets/macos-apps-dozer-settings.21702890.png",k="/assets/macos-apps-contexts-command-tab.9a4a73b7.png",f="/assets/macos-apps-contexts-option-tab.png.71eea241.png";const h={},g=n(`<h2 id="homebrew" tabindex="-1"><a class="header-anchor" href="#homebrew" aria-hidden="true">#</a> Homebrew</h2><p>Instalar <code>homebrew</code>:</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>/usr/bin/ruby -e <span class="token string">&quot;<span class="token variable"><span class="token variable">$(</span><span class="token function">curl</span> -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install<span class="token variable">)</span></span>&quot;</span>
